...
|---------|-------------|-------------|
| UnifiedSwarmCoordinator | `v2/src/swarm/coordinator.ts` | `v3/@tiara/swarm/src/unified-coordinator.ts` |
| Topology Manager | `v2/src/core/TopologyManager.ts` | `v3/@tiara/swarm/src/topology-manager.ts` |
| Agent Base Class | `v2/src/hive-mind/core/Agent.ts` | `v3/@tiara/swarm/src/domain/entities/` |
| Event-based Communication | `v2/src/hive-mind/core/Communication.ts` | `v3/@tiara/shared/src/events/` |
| Consensus Engine | `v2/src/hive-mind/integration/ConsensusEngine.ts` | `v3/@tiara/swarm/src/consensus/` |
...
| **Collective Memory** | `v2/src/hive-mind/core/Memory.ts` | MEDIUM | Already have better implementation in @tiara/memory |
...
All hooks exposed as MCP tools in `@tiara/cli/src/mcp-tools/hooks-tools.ts`:
...
- All tools in `@tiara/cli/src/mcp-tools/`
...
- All commands exported from `@tiara/cli/src/commands/index.ts`
