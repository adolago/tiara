  ...
  "PreToolUse": [
    {
      ...
      "hooks": [{
        "type": "command",
        "command": "npx @tiara/cli hooks pre-edit --file \"$TOOL_INPUT_file_path\"",
        "timeout": 5000,
    ...
    },
    {
      ...
      "hooks": [{
        "type": "command",
        "command": "npx @tiara/cli hooks pre-command --command \"$TOOL_INPUT_command\"",
        "timeout": 5000,
        "continueOnError": true
      }]
    },
    {
      ...
      "hooks": [{
        "type": "command",
        "command": "npx @tiara/cli hooks pre-task --description \"$TOOL_INPUT_prompt\"",
        "timeout": 5000,
        "continueOnError": true
      }]
    },
    {
      ...
      "hooks": [{
        "type": "command",
        "command": "npx @tiara/cli hooks pre-search --pattern \"$TOOL_INPUT_pattern\"",
        "timeout": 2000,
        "continueOnError": true
      }]
    }
  ...
  "PostToolUse": [
    {
      ...
      "hooks": [{
        "type": "command",
        "command": "npx @tiara/cli hooks post-edit --file \"$TOOL_INPUT_file_path\" --success \"$TOOL_SUCCESS\" --train-patterns",
        "timeout": 5000,
        "continueOnError": true
      }]
    },
    {
      ...
      "hooks": [{
        "type": "command",
        "command": "npx @tiara/cli hooks post-command --command \"$TOOL_INPUT_command\" --success \"$TOOL_SUCCESS\" --exit-code \"$TOOL_EXIT_CODE\"",
        "timeout": 5000,
        "continueOnError": true
      }]
    },
    {
      ...
      "hooks": [{
        "type": "command",
        "command": "npx @tiara/cli hooks post-task --agent-id \"$TOOL_RESULT_agent_id\" --success \"$TOOL_SUCCESS\" --analyze",
        "timeout": 5000,
        "continueOnError": true
      }]
    }
...
```json
{
  "UserPromptSubmit": [{
    "hooks": [{
      "type": "command",
      "command": "npx @tiara/cli hooks route --task \"$PROMPT\" --include-explanation",
      "timeout": 5000,
      "continueOnError": true
    }]
  }]
...
```json
{
  "SessionStart": [{
    "hooks": [{
      "type": "command",
      "command": "npx @tiara/cli hooks session-start --session-id \"$SESSION_ID\" --load-context",
      "timeout": 10000,
      "continueOnError": true
    }]
  }]
...
```json
{
  "Notification": [{
    "hooks": [{
      "type": "command",
      "command": "npx @tiara/cli hooks notify --message \"$NOTIFICATION_MESSAGE\" --swarm-status",
      "timeout": 3000,
      "continueOnError": true
    }]
  }]
