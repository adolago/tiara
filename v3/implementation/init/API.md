...
**Example:**
```typescript
import { detectPlatform } from '@tiara/cli/init';
...
```typescript
import { generateSettings, generateSettingsJson } from '@tiara/cli/init';
...
```typescript
import { generateMCPConfig, generateMCPJson, generateMCPCommands } from '@tiara/cli/init';
...
// ['claude mcp add claude-flow -- npx @tiara/cli mcp start', ...]
```
...
```typescript
import { generateStatuslineScript, generateStatuslineHook } from '@tiara/cli/init';
...
```typescript
import { executeInit, detectPlatform, DEFAULT_INIT_OPTIONS } from '@tiara/cli/init';
...
```typescript
import { executeInit, MINIMAL_INIT_OPTIONS } from '@tiara/cli/init';
