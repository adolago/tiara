...
The `@tiara/cli` package requires integration with `ruvector` for advanced code intelligence features:
...
These features are unique to ruvector and complement claude-flow's existing capabilities without duplicating functionality already present in `@tiara/embeddings` or `@tiara/memory`.

## Decision

Implement ruvector as an **OPTIONAL dependency** with graceful fallback, following the existing patterns in `@tiara/cli`.
...
```typescript
// v3/@tiara/cli/src/ruvector/availability.ts
...
```typescript
// v3/@tiara/cli/src/ruvector/adapters/router-adapter.ts
...
```typescript
// v3/@tiara/cli/src/ruvector/adapters/ast-adapter.ts
...
```typescript
// v3/@tiara/cli/src/ruvector/adapters/diff-adapter.ts
...
```typescript
// v3/@tiara/cli/src/ruvector/adapters/graph-adapter.ts
...
```typescript
// v3/@tiara/cli/src/commands/route.ts
...
```typescript
// v3/@tiara/cli/src/commands/analyze.ts
...
```typescript
// v3/@tiara/cli/src/ruvector/errors.ts
...
```typescript
// v3/@tiara/cli/src/mcp-tools/ruvector-tools.ts
...
```typescript
// v3/@tiara/cli/src/ruvector/index.ts
...
```typescript
// v3/@tiara/cli/src/commands/index.ts
...
```typescript
// v3/@tiara/cli/tests/ruvector/availability.test.ts
...
```typescript
// v3/@tiara/cli/tests/commands/route.test.ts
...
All cache utilities exported from `@tiara/cli/ruvector`:

```typescript
// Diff caches
import { clearDiffCache, clearAllDiffCaches } from '@tiara/cli/ruvector';

// Graph caches
import { clearGraphCaches, getGraphCacheStats } from '@tiara/cli/ruvector';

// Coverage caches
import { clearCoverageCache, getCoverageCacheStats } from '@tiara/cli/ruvector';
```
...
**Changes Made:**
- `@tiara/cli/src/commands/index.ts` - Refactored to use dynamic imports
...
**Changes Made:**
- `@tiara/memory/src/agentdb-adapter.ts` - Optimized bulk methods
...
| `@tiara/cli` | 3.0.0-alpha.24 | 3.0.0-alpha.25 |
| `@tiara/mcp` | 3.0.0-alpha.7 | 3.0.0-alpha.8 |

### Usage Examples

**Lazy Command Loading:**
```typescript
import { getCommandAsync, loadAllCommands } from '@tiara/cli';
...
- `@tiara/cli@3.0.0-alpha.25`
- `@tiara/mcp@3.0.0-alpha.8`
- `@tiara/memory@3.0.0-alpha.2`

### Performance Validation

All builds pass successfully:
```
✓ @tiara/cli build passed
✓ @tiara/mcp build passed
✓ @tiara/memory build passed
```
