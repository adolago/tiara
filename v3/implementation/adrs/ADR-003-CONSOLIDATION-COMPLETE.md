...
**File**: `/workspaces/claude-flow/v3/@tiara/swarm/src/unified-coordinator.ts`
...
**File**: `/workspaces/claude-flow/v3/@tiara/swarm/src/coordination/swarm-hub.ts`
 ...
 * /workspaces/claude-flow/v3/@tiara/swarm/src/coordination/swarm-hub.ts
 */
```
...
| `@tiara/swarm/README.md` | Module documentation | ✅ Created |
