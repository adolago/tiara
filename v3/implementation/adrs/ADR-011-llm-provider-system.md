...
### 1. Create `@tiara/providers` Package
...
Add LLM-specific hooks to `@tiara/hooks`:
...
### Neutral
- Integration with existing `@tiara/integration` multi-model-router
...
7. Add LLM hooks to @tiara/hooks
...
- V3 Multi-Model Router: `v3/@tiara/integration/src/multi-model-router.ts`
