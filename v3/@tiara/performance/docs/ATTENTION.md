...
```typescript
import { createFlashAttentionOptimizer } from '@tiara/performance';
...
```typescript
import { quickBenchmark } from '@tiara/performance';
...
```typescript
import { quickValidation } from '@tiara/performance';
...
```typescript
import { runAndDisplaySuite } from '@tiara/performance';
...
```bash
# Run all examples
npx tsx v3/@tiara/performance/src/examples/flash-attention-demo.ts
```
...
```typescript
import { FlashAttentionOptimizer } from '@tiara/performance';
