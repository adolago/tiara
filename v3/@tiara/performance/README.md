...
[![npm version](https://img.shields.io/npm/v/@tiara/performance.svg)](https://www.npmjs.com/package/@tiara/performance)
[![npm downloads](https://img.shields.io/npm/dm/@tiara/performance.svg)](https://www.npmjs.com/package/@tiara/performance)
...
```bash
npm install @tiara/performance
```

## Quick Start

```typescript
import { benchmark, BenchmarkRunner, V3_PERFORMANCE_TARGETS } from '@tiara/performance';
...
```typescript
import { benchmark } from '@tiara/performance';
...
```typescript
import { BenchmarkRunner } from '@tiara/performance';
...
```typescript
import { compareResults, printComparisonReport } from '@tiara/performance';
...
```typescript
import { V3_PERFORMANCE_TARGETS, meetsTarget } from '@tiara/performance';
...
```typescript
import { formatBytes, formatTime } from '@tiara/performance';
...
- [@tiara/memory](../memory) - Memory operations to benchmark
- [@tiara/swarm](../swarm) - Swarm coordination to benchmark
- [@tiara/neural](../neural) - Neural operations to benchmark
