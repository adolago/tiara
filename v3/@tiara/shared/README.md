...
[![npm version](https://img.shields.io/npm/v/@tiara/shared.svg)](https://www.npmjs.com/package/@tiara/shared)
[![npm downloads](https://img.shields.io/npm/dm/@tiara/shared.svg)](https://www.npmjs.com/package/@tiara/shared)
...
> Shared utilities, types, and core infrastructure for Claude Flow V3 - the foundation module used by all other @tiara packages.
...
import { ... } from '@tiara/shared';

// Submodule exports (for tree-shaking or specific imports)
import { ... } from '@tiara/shared/types';      // Type definitions
import { ... } from '@tiara/shared/core';       // Config, interfaces, orchestrator
import { ... } from '@tiara/shared/events';     // Event sourcing (ADR-007)
import { ... } from '@tiara/shared/hooks';      // Hooks system
import { ... } from '@tiara/shared/mcp';        // MCP server infrastructure
import { ... } from '@tiara/shared/security';   // Security utilities
import { ... } from '@tiara/shared/resilience'; // Retry, circuit breaker, rate limiter
```
...
```typescript
import { EventBus, EventCoordinator } from '@tiara/shared/events';
...
```typescript
import { HooksManager, Hook } from '@tiara/shared/hooks';
...
```typescript
import { HealthMonitor, HealthCheck } from '@tiara/shared/core';
...
This package is a dependency of all other @tiara modules:

- [@tiara/cli](../cli) - CLI module
- [@tiara/security](../security) - Security & validation
- [@tiara/memory](../memory) - AgentDB & HNSW indexing
- [@tiara/neural](../neural) - SONA learning & RL algorithms
- [@tiara/performance](../performance) - Benchmarking & optimization
- [@tiara/swarm](../swarm) - 15-agent coordination
- [@tiara/integration](../integration) - agentic-flow@alpha bridge
- [@tiara/testing](../testing) - TDD framework & fixtures
- [@tiara/deployment](../deployment) - Release management
- [@tiara/embeddings](../embeddings) - Embedding service
- [@tiara/hooks](../hooks) - Hooks system
