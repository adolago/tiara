...
```typescript
import { createEventBus } from '@tiara/shared/core';
import { createHookRegistry, createHookExecutor } from '@tiara/shared/hooks';
import { EventStore } from '@tiara/shared/events';
...
```typescript
import { HookEvent, HookContext } from '@tiara/shared/hooks';
...
import { Plugin } from '@tiara/shared';
import { HookEvent, HookPriority } from '@tiara/shared/hooks';
...
```typescript
// v3/@tiara/shared/src/mcp/tools/hooks.ts
