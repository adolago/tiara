...
**Updated Files**:
- ✅ `/v3/@tiara/shared/src/events/index.ts` - Module exports
- ✅ `/v3/@tiara/shared/src/index.ts` - Main module integration
- ✅ `/v3/@tiara/shared/package.json` - Dependencies added

## File Structure

```
v3/@tiara/shared/src/events/
...
```typescript
import { EventStore, createAgentSpawnedEvent } from '@tiara/shared/events';
...
```typescript
import { AgentStateProjection } from '@tiara/shared/events';
...
# Run example
npx tsx v3/@tiara/shared/src/events/example-usage.ts
```
...
**Module location**: `/workspaces/claude-flow/v3/@tiara/shared/src/events/`
