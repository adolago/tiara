...
[![npm version](https://img.shields.io/npm/v/@tiara/embeddings.svg)](https://www.npmjs.com/package/@tiara/embeddings)
[![npm downloads](https://img.shields.io/npm/dm/@tiara/embeddings.svg)](https://www.npmjs.com/package/@tiara/embeddings)
...
```bash
npm install @tiara/embeddings
```

## Quick Start

```typescript
import { createEmbeddingService, cosineSimilarity } from '@tiara/embeddings';
...
```typescript
import { OpenAIEmbeddingService } from '@tiara/embeddings';
...
```typescript
import { AgenticFlowEmbeddingService } from '@tiara/embeddings';
...
```typescript
import { TransformersEmbeddingService } from '@tiara/embeddings';
...
```typescript
import { MockEmbeddingService } from '@tiara/embeddings';
...
```typescript
import { createEmbeddingService } from '@tiara/embeddings';
...
```typescript
import { chunkText, estimateTokens, reconstructFromChunks } from '@tiara/embeddings';
...
```typescript
import { PersistentEmbeddingCache, isPersistentCacheAvailable } from '@tiara/embeddings';
...
- [@tiara/memory](../memory) - HNSW indexing and vector storage
- [@tiara/providers](../providers) - Multi-LLM provider system
- [@tiara/neural](../neural) - SONA learning integration
