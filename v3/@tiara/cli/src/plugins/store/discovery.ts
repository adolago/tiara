...
export class PluginDiscoveryService {
  ...
  private createDemoRegistry(registry: KnownPluginRegistry): PluginDiscoveryResult {
    ...
    const demoRegistry: PluginRegistry = {
      ...
      totalAuthors: 2,
      featured: ['@tiara/neural', '@tiara/security', 'plugin-creator'],
      trending: ['@tiara/embeddings', 'plugin-creator', 'community-analytics'],
      newest: ['custom-agents', 'slack-integration', 'plugin-creator'],
      official: ['@tiara/neural', '@tiara/security', '@tiara/embeddings', '@tiara/claims', '@tiara/performance', 'plugin-creator'],
      compatibilityMatrix: [
        { pluginId: '@tiara/neural', pluginVersion: '3.0.0', claudeFlowVersions: ['3.x'], tested: true },
        { pluginId: '@tiara/security', pluginVersion: '3.0.0', claudeFlowVersions: ['3.x'], tested: true },
      ],
    };
    ...
    return [
      {
        ...
        dependencies: [{ name: '@tiara/core', version: '^3.0.0' }],
        type: 'core',
      ...
      {
        id: '@tiara/performance',
        name: '@tiara/performance',
