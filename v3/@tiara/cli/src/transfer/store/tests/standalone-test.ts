...
async function main() {
  ...
  if (failed === 0) {
    ...
    console.log('    npx @tiara/cli patterns list');
    console.log('    npx @tiara/cli patterns list --featured');
    console.log('    npx @tiara/cli patterns search -q "agent"');
    console.log('    npx @tiara/cli patterns info -n <pattern-id>');
    console.log('');
  }
