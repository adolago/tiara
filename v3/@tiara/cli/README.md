...
[![npm version](https://img.shields.io/npm/v/@tiara/cli.svg)](https://www.npmjs.com/package/@tiara/cli)
[![npm downloads](https://img.shields.io/npm/dm/@tiara/cli.svg)](https://www.npmjs.com/package/@tiara/cli)
...
```typescript
import { CommandParser, OutputFormatter } from '@tiara/cli';
...
```typescript
import { OutputFormatter, output, Progress, Spinner } from '@tiara/cli';
...
```typescript
import { text, select, confirm, input, multiSelect } from '@tiara/cli';
...
- [@tiara/shared](../shared) - Shared types and utilities
- [@tiara/swarm](../swarm) - Swarm coordination module
- [@tiara/memory](../memory) - AgentDB memory system
- [@tiara/mcp](../mcp) - MCP server implementation
- [@tiara/hooks](../hooks) - Self-learning hooks system
- [@tiara/neural](../neural) - SONA neural learning
- [@tiara/embeddings](../embeddings) - Vector embeddings (75x faster with agentic-flow)
- [@tiara/security](../security) - CVE remediation & security patterns
