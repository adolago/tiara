...
[![npm version](https://img.shields.io/npm/v/@tiara/security.svg)](https://www.npmjs.com/package/@tiara/security)
[![npm downloads](https://img.shields.io/npm/dm/@tiara/security.svg)](https://www.npmjs.com/package/@tiara/security)
...
```bash
npm install @tiara/security
```

## Quick Start

```typescript
import { createSecurityModule } from '@tiara/security';
...
```typescript
import { PasswordHasher, createPasswordHasher } from '@tiara/security';
...
```typescript
import { CredentialGenerator, generateCredentials } from '@tiara/security';
...
```typescript
import { SafeExecutor, createDevelopmentExecutor } from '@tiara/security';
...
```typescript
import { PathValidator, createProjectPathValidator } from '@tiara/security';
...
// Sanitize HTML
import { sanitizeHtml } from '@tiara/security';
...
```typescript
import { TokenGenerator, quickGenerate } from '@tiara/security';
...
```typescript
import { auditSecurityConfig } from '@tiara/security';
...
- [@tiara/swarm](../swarm) - Swarm coordination (secure agent spawning)
