...
[![npm version](https://img.shields.io/npm/v/@tiara/neural.svg)](https://www.npmjs.com/package/@tiara/neural)
[![npm downloads](https://img.shields.io/npm/dm/@tiara/neural.svg)](https://www.npmjs.com/package/@tiara/neural)
...
```bash
npm install @tiara/neural
```

## Quick Start

```typescript
import { SONAManager, createSONAManager } from '@tiara/neural';
...
```typescript
import { PPO, A2C, DQN, QLearning, SARSA, DecisionTransformer } from '@tiara/neural';
...
- [@tiara/memory](../memory) - Memory integration
- `@ruvector/sona` - SONA learning engine

## Related Packages

- [@tiara/memory](../memory) - Vector memory for patterns
- [@tiara/integration](../integration) - agentic-flow integration
- [@tiara/performance](../performance) - Benchmarking
