...
[![npm version](https://img.shields.io/npm/v/@tiara/deployment.svg)](https://www.npmjs.com/package/@tiara/deployment)
[![npm downloads](https://img.shields.io/npm/dm/@tiara/deployment.svg)](https://www.npmjs.com/package/@tiara/deployment)
...
```typescript
import { prepareRelease } from '@tiara/deployment';
...
```typescript
import { publishToNpm } from '@tiara/deployment';
...
```typescript
import { validate } from '@tiara/deployment';
...
```typescript
import { Publisher } from '@tiara/deployment';
...
```typescript
import { Validator } from '@tiara/deployment';
...
```typescript
import { Validator, ReleaseManager, Publisher } from '@tiara/deployment';
...
```bash
# Prepare release
npx @tiara/deployment release --version 2.0.0 --changelog --tag

# Publish to npm
npx @tiara/deployment publish --tag latest --access public

# Validate package
npx @tiara/deployment validate
```
