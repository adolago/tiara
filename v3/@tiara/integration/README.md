...
[![npm version](https://img.shields.io/npm/v/@tiara/integration.svg)](https://www.npmjs.com/package/@tiara/integration)
[![npm downloads](https://img.shields.io/npm/dm/@tiara/integration.svg)](https://www.npmjs.com/package/@tiara/integration)
...
```typescript
import { AgenticFlowBridge, createAgenticFlowBridge } from '@tiara/integration';
...
- [@tiara/neural](../neural) - SONA learning module
- [@tiara/memory](../memory) - AgentDB memory
