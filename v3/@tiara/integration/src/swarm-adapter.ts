...
// ============================================================================
// V3 Swarm Types (Source Interface from @tiara/swarm)
// ============================================================================

/**
 * V3 Topology types (from @tiara/swarm)
 */
export type V3TopologyType = 'mesh' | 'hierarchical' | 'centralized' | 'hybrid';

/**
 * V3 Agent Domain types (from @tiara/swarm)
 */
export type V3AgentDomain = 'queen' | 'security' | 'core' | 'integration' | 'support';

/**
 * V3 Agent State interface (simplified from @tiara/swarm)
 */
...
/**
 * V3 Task Definition interface (simplified from @tiara/swarm)
 */
 ...
 * Usage:
 * ```typescript
 * import { SwarmAdapter, createSwarmAdapter } from '@tiara/integration';
 *
