...
[![npm version](https://img.shields.io/npm/v/@tiara/testing.svg)](https://www.npmjs.com/package/@tiara/testing)
[![npm downloads](https://img.shields.io/npm/dm/@tiara/testing.svg)](https://www.npmjs.com/package/@tiara/testing)
...
```bash
npm install @tiara/testing vitest --save-dev
```
...
```typescript
import { createMockClock, measureTime } from '@tiara/testing';
...
```typescript
import { createTestEmitter } from '@tiara/testing';
...
```typescript
import { MockAgentDB } from '@tiara/testing';
...
```typescript
import { MockSwarmCoordinator } from '@tiara/testing';
...
```typescript
import { MockMCPClient, createStandardMockMCPClient } from '@tiara/testing';
...
```typescript
import { registerCustomMatchers } from '@tiara/testing';
...
```typescript
import { setupV3Tests, configureTestEnvironment } from '@tiara/testing';
...
```typescript
import { createSetupContext, createTestScope } from '@tiara/testing';
...
```typescript
import { createPerformanceTestHelper } from '@tiara/testing';
...
```typescript
import { assertV3PerformanceTargets, TEST_CONFIG } from '@tiara/testing';
