...
export class IntegrationRegressionSuite {
  ...
  private registerDefaultTests(): void {
    ...
    this.tests.push({
      ...
      timeout: 5000,
      run: async () => {
        const { UnifiedMemoryService, HybridBackend } = await import('@tiara/memory');
    ...
    this.tests.push({
      ...
      timeout: 10000,
      run: async () => {
        const { HybridBackend, UnifiedMemoryService } = await import('@tiara/memory');
    ...
    this.tests.push({
      ...
      timeout: 5000,
      run: async () => {
        const { EventBus, createAgentSpawnedEvent } = await import('@tiara/shared');
    ...
    this.tests.push({
      ...
      run: async () => {
        try {
          const { UnifiedSwarmCoordinator } = await import('@tiara/swarm');
    ...
    this.tests.push({
      ...
      run: async () => {
        try {
          const { HookRegistry, HookPriority } = await import('@tiara/shared');
    ...
    this.tests.push({
      ...
      run: async () => {
        try {
          ...
          const shared = await import('@tiara/shared');
    ...
    this.tests.push({
      ...
      run: async () => {
        try {
          const memory = await import('@tiara/memory');
          return (
    ...
    this.tests.push({
      ...
      run: async () => {
        try {
          const swarm = await import('@tiara/swarm');
