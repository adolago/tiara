...
[![npm version](https://img.shields.io/npm/v/@tiara/mcp.svg)](https://www.npmjs.com/package/@tiara/mcp)
...
- **Zero Dependencies** - No @tiara/* dependencies

## Installation

```bash
npm install @tiara/mcp
```

## Quick Start

```typescript
import { quickStart, defineTool } from '@tiara/mcp';
...
```typescript
import { createMCPServer } from '@tiara/mcp';
...
```typescript
import { createToolRegistry, defineTool } from '@tiara/mcp';
...
```typescript
import { createSessionManager } from '@tiara/mcp';
...
```typescript
import { createConnectionPool } from '@tiara/mcp';
...
```typescript
import { createMCPServer, createTextResource } from '@tiara/mcp';
...
```typescript
import { createMCPServer, definePrompt, textMessage, interpolate } from '@tiara/mcp';
