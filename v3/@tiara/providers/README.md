...
[![npm version](https://img.shields.io/npm/v/@tiara/providers.svg)](https://www.npmjs.com/package/@tiara/providers)
[![npm downloads](https://img.shields.io/npm/dm/@tiara/providers.svg)](https://www.npmjs.com/package/@tiara/providers)
...
```bash
npm install @tiara/providers
```

## Quick Start

```typescript
import { createProviderManager } from '@tiara/providers';
...
```typescript
import { ProviderManager, createProviderManager } from '@tiara/providers';
...
```typescript
import { createProviderManager } from '@tiara/providers';
import { createUnifiedSwarmCoordinator } from '@tiara/swarm';
...
- [@tiara/embeddings](../embeddings) - Embedding generation
- [@tiara/memory](../memory) - Vector storage and retrieval
